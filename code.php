...
<?php
  ...
  if (isset($_POST["submit"])) {
    ...
    $saveSQL = "INSERT INTO `users`(`ID`, `Date`, `Email`, `Phone`, `First Name`, `Last Name`, `Password`, `Region`) VALUES(NULL, CURRENT_TIMESTAMP, $email, $phone, $firstName, $lastName, $hashedPass, $region)";
